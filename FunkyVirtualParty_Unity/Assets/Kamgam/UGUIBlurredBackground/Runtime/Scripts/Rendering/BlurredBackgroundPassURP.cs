    ...
    public class BlurredBackgroundPassURP : ScriptableRenderPass
    {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
			...
			for (int i = 0; i < Iterations; i++)
            {
				...
				using (var builder = renderGraph.AddRasterRenderPass<BlurPassData>("UGUIBlurredBackground_BlurHorizontal_" + i, out var passData, profilingSampler))
				{
				...
				// Blur vertical pass
				using (var builder = renderGraph.AddRasterRenderPass<BlurPassData>("UGUIBlurredBackground_BlurVertical_" + i, out var passData, profilingSampler))
				{
					passData.material = Material;
