...
#pragma warning restore IDE1006
        ...
        where TResult : IGeneratedResult
    {
        ...
        internal async UniTask LoadAllAttachedFilesAsync()
        {
            if (attachedFiles.IsNullOrEmpty()) return;
        ...
        public TSelf SetReasoningOptions(ReasoningOptions options)
        {
        ...
        public TSelf SetSpeechOutputOptions(SpeechOutputOptions options = null)
        {
            if (options == null) return this as TSelf;
    ...
    public class GENSpeechTask : GENAudioOutputTask<GENSpeechTask, string>
    {
        ...
        internal Api? api; // OpenAI, ElevenLabs, Gemini, etc.
        ...
        /// </summary>
        public GENSpeechTask SetVoice(Api api, string voice)
        {
            this.api = api;
            voiceId = voice;
            return this;
        ...
        {
            if (voice == null) throw new ArgumentNullException(nameof(voice), "Voice cannot be null.");
            api = voice.Api;
            voiceId = voice.Id;
            return this;
        }
