...
public partial class DataSyncTestModel : RealtimeModel {
    ...
    public delegate void PropertyChangedHandler<in T>(DataSyncTestModel model, T value);
    ...
    public DataSyncTestModel() : base(null) {
