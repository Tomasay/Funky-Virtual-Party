...
public partial class ShootoutGameSyncModel : RealtimeModel {
    public string state {
        get {
    ...
    public delegate void PropertyChangedHandler<in T>(ShootoutGameSyncModel model, T value);
    ...
    public ShootoutGameSyncModel() : base(null) {
