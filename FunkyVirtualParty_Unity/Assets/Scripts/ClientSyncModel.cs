...
public partial class ClientSyncModel : RealtimeModel {
    ...
    public bool onDeathTrigger {
        get {
            return _onDeathTriggerProperty.value;
        }
        set {
            if (_onDeathTriggerProperty.value == value) return;
            _onDeathTriggerProperty.value = value;
            InvalidateReliableLength();
            FireOnDeathTriggerDidChange(value);
        }
    }
    
    public bool isDebugPlayer {
        get {
            return _isDebugPlayerProperty.value;
        }
        set {
            if (_isDebugPlayerProperty.value == value) return;
            _isDebugPlayerProperty.value = value;
            InvalidateReliableLength();
            FireIsDebugPlayerDidChange(value);
        }
    }
    ...
    public event PropertyChangedHandler<bool> isDebugPlayerDidChange;
    ...
    private ReliableProperty<bool> _isDebugPlayerProperty;
    ...
    public ClientSyncModel() : base(null) {
        ...
        _isDebugPlayerProperty = new ReliableProperty<bool>(10, _isDebugPlayer);
    }
    ...
    protected override void OnParentReplaced(RealtimeModel previousParent, RealtimeModel currentParent) {
        ...
        _isDebugPlayerProperty.UnsubscribeCallback();
    }
    ...
    private void FireOnDeathTriggerDidChange(bool value) {
        try {
            onDeathTriggerDidChange?.Invoke(this, value);
        } catch (System.Exception exception) {
            UnityEngine.Debug.LogException(exception);
        }
    }
    
    private void FireIsDebugPlayerDidChange(bool value) {
        try {
            isDebugPlayerDidChange?.Invoke(this, value);
        } catch (System.Exception exception) {
            UnityEngine.Debug.LogException(exception);
        }
    }
    ...
    protected override int WriteLength(StreamContext context) {
        ...
        length += _isDebugPlayerProperty.WriteLength(context);
        return length;
    }
    ...
    protected override void Write(WriteStream stream, StreamContext context) {
        ...
        writes |= _isDebugPlayerProperty.Write(stream, context);
    ...
    protected override void Read(ReadStream stream, StreamContext context) {
        ...
        while (stream.ReadNextPropertyID(out uint propertyID)) {
            ...
            switch (propertyID) {
                ...
                case (uint) PropertyID.OnDeathTrigger: {
                    changed = _onDeathTriggerProperty.Read(stream, context);
                    if (changed) FireOnDeathTriggerDidChange(onDeathTrigger);
                    break;
                }
                case (uint) PropertyID.IsDebugPlayer: {
                    changed = _isDebugPlayerProperty.Read(stream, context);
                    if (changed) FireIsDebugPlayerDidChange(isDebugPlayer);
                    break;
                }
                default: {
                    stream.SkipProperty();
