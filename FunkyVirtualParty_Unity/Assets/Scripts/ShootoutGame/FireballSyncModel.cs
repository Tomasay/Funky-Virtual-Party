...
public partial class FireballSyncModel
{
    ...
    private bool _smokePuffTrigger; //Setting this to true triggers the smoke puff particle system to play, and will automatically reset to false

    [RealtimeProperty(5, true, true)]
    private bool _explosionTrigger; //Setting this to true triggers the explosion particle system to play, and will automatically reset to false
}
...
public partial class FireballSyncModel : RealtimeModel {
    ...
    public bool smokePuffTrigger {
        get {
            return _smokePuffTriggerProperty.value;
        }
        set {
            if (_smokePuffTriggerProperty.value == value) return;
            _smokePuffTriggerProperty.value = value;
            InvalidateReliableLength();
            FireSmokePuffTriggerDidChange(value);
        }
    }
    ...
    public event PropertyChangedHandler<bool> smokePuffTriggerDidChange;
    ...
    private ReliableProperty<bool> _smokePuffTriggerProperty;
    ...
    public FireballSyncModel() : base(null) {
        ...
        _smokePuffTriggerProperty = new ReliableProperty<bool>(4, _smokePuffTrigger);
        _explosionTriggerProperty = new ReliableProperty<bool>(5, _explosionTrigger);
    }
    ...
    protected override void OnParentReplaced(RealtimeModel previousParent, RealtimeModel currentParent) {
        ...
        _smokePuffTriggerProperty.UnsubscribeCallback();
    ...
    private void FireSmokePuffTriggerDidChange(bool value) {
        try {
            smokePuffTriggerDidChange?.Invoke(this, value);
        } catch (System.Exception exception) {
            UnityEngine.Debug.LogException(exception);
        }
    }
    ...
    protected override int WriteLength(StreamContext context) {
        ...
        length += _smokePuffTriggerProperty.WriteLength(context);
    ...
    protected override void Write(WriteStream stream, StreamContext context) {
        ...
        writes |= _smokePuffTriggerProperty.Write(stream, context);
    ...
    protected override void Read(ReadStream stream, StreamContext context) {
        ...
        while (stream.ReadNextPropertyID(out uint propertyID)) {
            ...
            switch (propertyID) {
                ...
                case (uint) PropertyID.SmokePuffTrigger: {
                    changed = _smokePuffTriggerProperty.Read(stream, context);
                    if (changed) FireSmokePuffTriggerDidChange(smokePuffTrigger);
                    break;
                }
    ...
    private void UpdateBackingFields() {
        ...
        _boosted = boosted;
        _active = active;
        _smokePuffTrigger = smokePuffTrigger;
