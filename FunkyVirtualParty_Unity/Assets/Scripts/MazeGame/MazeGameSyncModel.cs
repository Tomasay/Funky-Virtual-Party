...
public partial class MazeGameSyncModel : RealtimeModel {
    ...
    public UnityEngine.Vector3 marbleMazePos {
        get {
            return _marbleMazePosProperty.value;
        }
        set {
            if (_marbleMazePosProperty.value == value) return;
            _marbleMazePosProperty.value = value;
            InvalidateReliableLength();
            FireMarbleMazePosDidChange(value);
        }
    }
    ...
    public event PropertyChangedHandler<UnityEngine.Vector3> marbleMazePosDidChange;
    ...
    private ReliableProperty<UnityEngine.Vector3> _marbleMazePosProperty;
    ...
    public MazeGameSyncModel() : base(null) {
        ...
        _marbleMazePosProperty = new ReliableProperty<UnityEngine.Vector3>(4, _marbleMazePos);
    }
    ...
    protected override void OnParentReplaced(RealtimeModel previousParent, RealtimeModel currentParent) {
        ...
        _marbleMazePosProperty.UnsubscribeCallback();
    }
    ...
    private void FireMarbleMazePosDidChange(UnityEngine.Vector3 value) {
        try {
            marbleMazePosDidChange?.Invoke(this, value);
        } catch (System.Exception exception) {
            UnityEngine.Debug.LogException(exception);
        }
    }
    ...
    protected override int WriteLength(StreamContext context) {
        ...
        length += _marbleMazePosProperty.WriteLength(context);
        return length;
    }
    ...
    protected override void Write(WriteStream stream, StreamContext context) {
        ...
        writes |= _marbleMazePosProperty.Write(stream, context);
    ...
    protected override void Read(ReadStream stream, StreamContext context) {
        ...
        while (stream.ReadNextPropertyID(out uint propertyID)) {
            ...
            switch (propertyID) {
                ...
                case (uint) PropertyID.MarbleMazePos: {
                    changed = _marbleMazePosProperty.Read(stream, context);
                    if (changed) FireMarbleMazePosDidChange(marbleMazePos);
                    break;
                }
                default: {
                    stream.SkipProperty();
